...
EXCLUDED = ["بأسعار", "بسعر", "باسعار", "للتواصل", "مشكلتها", "مشكلتي", "تخصص", "التخصص", "مشكلة", "المشكله", "تواصل واتس","التواصل", "للحجز", "خصم خاص", "عرض خاص", "تدفعون لهم بعد", "الدفع بعد", "نقدم لك", "نقدم لكم", "خدماتنا", "خدمة تعليمية", "تواصل الآن", "تواصل معنا", "تواصلوا معنا", "يحلف", "إذا تبون", "مايسوي", "ذي تسوي", "ذا يسوي", "ذي يسوي", "انا اسوي", "يبي", "اعرف حد", "اعرف واحد", "الموزونات", "المنصة", "الموازونة", "انقبل", "التحويل", "رغبات", "الرغبات", "قبول", "القبول", "يسوي له", "هذا يحل", "اسوي له", "يحتاج إلى حد", "يحتاج حد", "اعرف شخص", "القيد", "قيد", "منصه", "اذا تبون", "يحليلك", "مايسوي", "موراضي", "يحلوين", "يحلليلك", "نقدم", "أقدم", "اقدم", "شسوي", "ما يسوي", "مشكله", "الدعم", "المنصه", "الاستيب", "الستيب", "ستيب", "للقبول", "بالقبول", "تبي", "الذي حابب"]
...
def register_handler(client: TelegramClient, session_number: int) -> None:
    ...
    async def handler(event):
        ...
        try:
            ...
            # التصفية الأوسع مثل الملف الأول:
            # يجب وجود كلمة مفتاحية، وعدم وجود كلمة مستبعدة.
            if not text:
                return
